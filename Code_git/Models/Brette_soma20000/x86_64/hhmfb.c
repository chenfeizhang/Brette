...
extern Memb_func* memb_func;
 ...
 "setdata_hhmfb", _hoc_setdata,
 "rates_hhmfb", _hoc_rates,
 "vtrap_hhmfb", _hoc_vtrap,
 0, 0
};
#define vtrap vtrap_hhmfb
...
#define _gth 0
#define htau_hhmfb _thread1data[0]
#define htau _thread[_gth]._pval[0]
#define hinf_hhmfb _thread1data[1]
#define hinf _thread[_gth]._pval[1]
#define mtau_hhmfb _thread1data[2]
#define mtau _thread[_gth]._pval[2]
#define minf_hhmfb _thread1data[3]
#define minf _thread[_gth]._pval[3]
#define ntau_hhmfb _thread1data[4]
#define ntau _thread[_gth]._pval[4]
#define ninf_hhmfb _thread1data[5]
#define ninf _thread[_gth]._pval[5]
#define usetable usetable_hhmfb
 double usetable = 1;
#define vShift_inact vShift_inact_hhmfb
 double vShift_inact = 0;
#define vShift vShift_hhmfb
 double vShift = 12;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "gl_hhmfb", 0, 1e+09,
 "gkbar_hhmfb", 0, 1e+09,
 "gnabar_hhmfb", 0, 1e+09,
 "usetable_hhmfb", 0, 1,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "vShift_hhmfb", "mV",
 "vShift_inact_hhmfb", "mV",
 "mtau_hhmfb", "ms",
 "htau_hhmfb", "ms",
 "ntau_hhmfb", "ms",
 "am0_hhmfb", "/ms",
 ...
 "vShift_hhmfb", &vShift_hhmfb,
 "vShift_inact_hhmfb", &vShift_inact_hhmfb,
 "minf_hhmfb", &minf_hhmfb,
 "hinf_hhmfb", &hinf_hhmfb,
 "ninf_hhmfb", &ninf_hhmfb,
 "mtau_hhmfb", &mtau_hhmfb,
 "htau_hhmfb", &htau_hhmfb,
 "ntau_hhmfb", &ntau_hhmfb,
 "usetable_hhmfb", &usetable_hhmfb,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 7);
 	...
 	ivoc_help("help ?1 hhmfb /home/chenfei/Code_git/Models/Brette_soma20000/x86_64/hhmfb.mod\n");
...
static int _reset;
static char *modelname = "hhmfb.mod   modified squid sodium, potassium, and leak channels";
...
static int  _f_rates ( _threadargsprotocomma_ double _lv ) {
   double _lalpha , _lbeta , _lsum , _lvS ;
  _lvS = _lv - vShift ;
   _lalpha = am0 * vtrap ( _threadargscomma_ - ( _lvS - am1 ) , am2 ) ;
   _lbeta = bm0 * exp ( - _lvS / bm1 ) ;
   _lsum = _lalpha + _lbeta ;
   mtau = 1.0 / _lsum ;
   minf = _lalpha / _lsum ;
   _lalpha = hScale * ah0 * exp ( - ( _lvS - vShift_inact ) / ah1 ) ;
   _lbeta = hScale * bh0 / ( exp ( - ( ( _lvS - vShift_inact ) + bh1 ) / bh2 ) + 1.0 ) ;
   _lsum = _lalpha + _lbeta ;
   htau = 1.0 / _lsum ;
   hinf = _lalpha / _lsum ;
